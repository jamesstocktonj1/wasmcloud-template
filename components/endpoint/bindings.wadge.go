...
//go:linkname wasmimport_Greet github.com/jamesstocktonj1/wasmcloud-template/components/endpoint/gen/jamesstocktonj1/wasmcloud-template/connect.wasmimport_Greet
func wasmimport_Greet(req0 *uint8, req1 uint32, req2 *uint8, req3 uint32, result *string) {
	var __p runtime.Pinner
	defer __p.Unpin()
	if __err := wadge.WithCurrentInstance(func(__instance *wadge.Instance) error {
		return __instance.Call("jamesstocktonj1:wasmcloud-template/connect@0.1.0", "greet", func() unsafe.Pointer {
			ptr := unsafe.Pointer(req0)
			__p.Pin(ptr)
			return ptr
		}(), func() unsafe.Pointer {
			ptr := unsafe.Pointer(&req1)
			__p.Pin(ptr)
			return ptr
		}(), func() unsafe.Pointer {
			ptr := unsafe.Pointer(req2)
			__p.Pin(ptr)
			return ptr
		}(), func() unsafe.Pointer {
			ptr := unsafe.Pointer(&req3)
			__p.Pin(ptr)
			return ptr
		}(), func() unsafe.Pointer {
